# ARTEM KUDRYAVTSEV
**Junior ML Engineer | Machine Learning | Deep Learning**
...
- Create RAG pipelines with embeddings, chunking, vector storage, and local LLMs
- Work with tabular data, time series, text, and images
- Run experiments, evaluate model quality, and document results clearly
...
- **Core ML/DL:** PyTorch, TensorFlow, Keras, scikit-learn, XGBoost
- **Machine Learning:** regression, classification, model evaluation, feature engineering, preprocessing
- **Deep Learning:** neural networks, CNNs, transfer learning, training and validation workflows
- **NLP:** transformers, DistilBERT, tokenization, embeddings, text classification
- **Computer Vision:** image classification, object detection, semantic segmentation, U-Net, YOLO
- **LLM / RAG:** local LLM workflows, document chunking, embeddings, vector search, Chroma
- **Data Analysis:** NumPy, pandas, Matplotlib, Seaborn, Jupyter Notebook
...
## Links
- [GitHub](https://github.com/himynameisartem)
- [LinkedIn](http://www.linkedin.com/in/artem-kudryavtsev-1a1bb92b8)
